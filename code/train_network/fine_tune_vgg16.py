"""
This script is used for training the Model 2 in our project.
The Model 2 is training the VGG16 network with ImageNet weights 
and the generated images are the training data.
"""
import os
import numpy as np
import imageio
...
train_dir = "/home/yuqi/imagenet_replay/train"
validation_dir = "/home/yuqi/imagenet_replay/val_resized"

# Checkpoint to save model
checkpoint_filename = '/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_imagenet/saved_model.h5'
# History file to save the value at each epoch
history_filename = '/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_imagenet/history_log.csv'
...
list_of_dirs.sort()
# Create a list of these 1000 classes
class_numbers = range(1000)
# Assign each class label this number (this will be the number in the prediction layer)
y_classes = {list_of_dirs[i]:class_numbers[i] for i in range(1000)}

# Gets the appropriate class number for each image in the list
y_train = [y_classes[y] for y in y_cls_train]
# Creates a one-hot vector of 1s and 0s to code the classes
...
os.chdir('/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_imagenet/')

# Save the history file
import pickle
with open('vgg_16_train_imagenet.pickle','wb') as f:
