"""
This script is used for training the Model 1 in our project.
...
checkpoint_filename = '/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_from_scratch/saved_model.h5'
# History file to save the value at each epoch.
history_filename = '/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_from_scratch/history_log.csv'
...
# Divide this into the paths and class labels
...
os.chdir('/home/yuqi/imagenet_replay/checkpoint/vgg_16_train_from_scratch/')

# Save the history file
import pickle
with open('vgg_166_train_from_scratch.pickle','wb') as f:
