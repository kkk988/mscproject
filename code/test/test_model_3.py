"""
This script test the top 5 accuracy for the Model 3 in our project.
"""
import os
...
# Load the best model we saved when training the Model 3
model = load_model('/home/yuqi/new_class/checkpoint/saved_model.h5', custom_objects=None, compile=True)
shape = 224,224,3
...
top_5_by_class_array = np.zeros(1002)  
total_top_5 = 0
total_file_count = 0


for imagenet_class in range(1001):
...
top_5_by_class_array[1001] = top_5_accuracy

np.savetxt("/home/yuqi/imagenet_replay/testing/top_5_prediction/new_class_1001_top_5_by_class.csv", top_5_by_class_array, delimiter=",")
